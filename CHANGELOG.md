...
- Fix: a missing or non-numeric meter reading no longer fails a fetch whose statistics were already imported; the meter reading sensor is left empty instead of showing 0 kWh
- Fix: a non-numeric 15-minute value is skipped instead of failing the whole fetch
